...
const fallbackSessions: Session[] = [
  ...
  },
  {
    ...
    availability: '2 spots',
    partners: 2,
    tags: ['Board session', 'New set'],
    note: 'Board burn. Short rests, music on.',
  },
  {
    id: 's6',
    host: 'Lea',
    ...
    availability: '1 spot',
    partners: 3,
    tags: ['Belay verified', 'Pitches'],
    note: 'Mileage on lead circuit. Soft catches.',
  },
]
...
const fallbackEvents: Event[] = [
  ...
  {
    id: 'e-beerbelly',
    title: 'Beerbelly Crew',
    host: 'Einstein Boulderhalle',
    date: 'Wednesday',
    time: '17:30',
    location: 'Munich - Einstein Boulderhalle',
    type: 'Gym meetup',
    description: 'The beerbelly weekly meetup. Chill climbing with the Dudes.',
    attendees: 4,
    capacity: 12,
    tags: ['Chill', 'Hangout'],
  },
  {
    id: 'e-boardlords',
    title: 'Munich Board-Lords',
    host: 'Boulderwelt Ost',
    date: 'Saturday',
    time: '14:00',
    location: 'Munich - Boulderwelt Ost',
    type: 'Gym meetup',
    description: "Pull hard. Don't let go. Hard Board Climbing Session.",
    attendees: 5,
    capacity: 7,
    tags: ['Training', 'Board'],
  },
