...
|----|-------|--------|-------|----------|------|
| TICKET-ONB-001 | Onboarding Flow Optimization (22-35) | Proposed | Product | P0 | `TICKETS/onboarding-flow-optimization.md` |
...
| TICKET-UX-002 | UI/UX Polish | Proposed | Product/Design/Eng | P1 | `TICKETS/ui-ux-polish.md` |
