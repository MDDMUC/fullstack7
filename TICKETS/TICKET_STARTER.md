...
Use this file to start any new work item.
...
2) Create a product ticket
- Copy `TICKETS/TEMPLATE_PRODUCT.md` into `TICKETS/<short-title>.md`
...
Definition of Done
- Use `DEFINITION_OF_DONE.md` for any shipped work
